...
<body id="index" onload="">
	<div id="main">
		...
		<p>This page includes basic documentation, and links to sample pages that use the Big Blue Button API via a PHP bridge. You can read this page and also inspect the included files to see how it works. Original documentation for the base Big Blue Button API itself can be found at the following URL:</p>
		<p><a href="http://code.google.com/p/bigbluebutton/wiki/API">http://code.google.com/p/bigbluebutton/wiki/API</a></p>
		...
		<dl>
			...
			<dd>
				<div class="method">
					<p>METHOD: <span class="methodname">createMeetingWithXmlResponseArray($creationParams)</span></p>
				</div>
...
$result = $bbb->createMeetingWithXmlResponseArray($creationParams);
			...
			<dd>
				<div class="method">
					<p>METHOD: <span class="methodname">getJoinMeetingURL($joinParams)</span></p>
				</div>
			...
			<dd>
				<div class="method">
					<p>METHOD: <span class="methodname">endMeetingWithXmlResponseArray($endParams)</span></p>
				</div>
		...
		<dl>
			...
			<dd>
				<div class="method">
					<p>METHOD: <span class="methodname">isMeetingRunningWithXmlResponseArray($meetingId)</span></p>
				</div>
			...
			<dd>
				<div class="method">
					<p>METHOD: <span class="methodname">getMeetingsWithXmlResponseArray()</span></p>
				</div>
			...
			<dd>
				<div class="method">
					<p>METHOD: <span class="methodname">getMeetingInfoWithXmlResponseArray($infoParams)</span></p>
				</div>
		...
		<p><b>Convenience pages for recording</b>: <a href="examples/createRecordedMeeting.php">Create a meeting</a> with 'record' set to 'true' now. This will create a 5 minute long meeting that will be recorded once you <a href="examples/getJoinMeetingUrlModeratorRecord.php">join into it as moderator and let it run</a>. (The meeting will stop after 5 minutes.). The meetingId for this recorded meeting will be <b>'12345'</b>. Once recorded, you can use the methods below to test your results. To get success with publish and delete methods, you'll need to get back a valid recordID using the getRecordingsWithXmlResponseArray() method first, and then add the recordID to the example pages for publishing and deleting recordings.
			<dl>
				...
				<dd>
					<div class="method">
						<p>METHOD: <span class="methodname">getRecordingsWithXmlResponseArray($recordingParams)</span></p>
					</div>
				...
				<dd>
					<div class="method">
						<p>METHOD: <span class="methodname">publishRecordingsWithXmlResponseArray($recordingParams)</span></p>
					</div>
				...
				<dd>
					<div class="method">
						<p>METHOD: <span class="methodname">deleteRecordingsWithXmlResponseArray($recordingParams)</span></p>
					</div>
